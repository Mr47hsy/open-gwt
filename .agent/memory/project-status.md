---
name: project-status
description: As of 2026-09-23 the MVP milestones M1, M2 and M3 are merged into develop (PRs #1–#6) and the owner has play-tested the Unity client against the bot in Chinese; mobile smoke builds are deferred, Redis backends (M2b) not started.
metadata:
  type: project
---
