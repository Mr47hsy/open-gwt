...
- [Project status](project-status.md) — MVP M1–M3 merged; ADR 0009 phase B replaced the v1 core, server on protocol 2, client cannot play until phase E; M2b not started
- [Backlog](backlog.md) — open work by layer for parallel feature sessions
- [Ruleset v2](ruleset-v2.md) — two-row standalone ruleset (ADR 0009); phases A and B done, vocabulary complete and checked against the standalone game, C–F next in order
...
- [Licensing split](licensing-split.md) — MIT for code, CC BY 4.0 for original assets; third-party fonts under OFL in `client/Assets/OpenGwt/Fonts`
