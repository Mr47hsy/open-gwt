...
- [Project status](project-status.md) — docs-only repository; `client/` and `server/` do not exist yet
- [Branch strategy](branch-strategy.md) — `main` / `release` / `develop` exist; **the `main` vs `release` overlap is unresolved**
